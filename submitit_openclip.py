...
def parse_args():
    ...
    parser.add_argument("--partition", default="learnlab,learnfair",
                        type=str, help="Partition where to submit")
    parser.add_argument("--use_volta32", action='store_true',
                        help="Request 32G V100 GPUs")
    parser.add_argument("--use_ampere80", action='store_true',
                        help="Request 80G A100 GPUs")
...
class Trainer(object):
    ...
    def checkpoint(self):
        ...
        checkpoint_file = os.path.join(
            self.args.config.output_dir, "checkpoints", "epoch_latest.pt")
...
def main(args):
    ...
    executor.update_parameters(
        ...
        # exclude='learnfair7675,learnfair7700,learnfair7702,learnfair7704,learnfair7494',# 'learnfair6007,learnfair6008,learnfair6009,learnfair6010,learnfair6011,learnfair6012,learnfair6013,learnfair6014,learnfair6015,learnfair6016,learnfair6017,learnfair6018,learnfair6019,learnfair6022',
        # exclude='learnfair7459,learnfair7468,learnfair7469,learnfair7470,learnfair7477,learnfair7480,learnfair7482,learnfair7488,learnfair7498,learnfair7508,learnfair7517,learnfair7522,learnfair7527,learnfair7594,learnfair7600,learnfair7602,learnfair7604,learnfair7605,learnfair7618,learnfair7644,learnfair7657,learnfair7670,learnfair7691',
        ** kwargs
    )
    ...
    print("Submitted job_id:", job.job_id, "@",
          str(args.job_dir).replace("%j", job.job_id))
...
def submit():
    ...
    if len(args.resume):
        checkpoint_file = os.path.join(
            config.output_dir, "checkpoints", args.resume)
